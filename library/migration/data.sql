...
CREATE TABLE `romi_settings` (
  ...
  `birthday_reminder_enabled` tinyint(1) NOT NULL DEFAULT '0',
  `birthday_reminder_hour` tinyint NOT NULL DEFAULT '8',
  `birthday_reminder_minute` tinyint NOT NULL DEFAULT '0',
  `birthday_reminder_template` text NOT NULL,
  `birthday_reminder_log` json NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4;

INSERT INTO `romi_settings` (`id`, `site_title`, `site_description`, `site_keywords`, `site_name`, `site_favicon`, `site_logo`, `header_background`, `home_avatar`, `home_title`, `home_subtitle`, `home_links`, `independent_pages`, `links`, `site_url`, `smtp_host`, `smtp_port`, `smtp_username`, `smtp_password`, `smtp_email`, `birthday_reminder_enabled`, `birthday_reminder_hour`, `birthday_reminder_minute`, `birthday_reminder_template`, `birthday_reminder_log`) VALUES
(1, 'Romi Nest', 'Arimura Sena\'s personal website and blog powered by Angular and Rust | AS 的个人网站和博客，由 Angular 和 Rust 驱动', 'arimura sena, Romi Nest, personal website, blog, angular, rust, as, 个人网站, 博客, Angular, Rust, AS, anime, acg, 二次元, 动漫, 原神, galgame, 视觉小说, 个人站, 动画, visual-novels, github, developer, coder, 开源, open-source, 前端, 后端, 开发者, 开源, 个人, idealism, 理想主义者, 自由主义者, 民主, 自由, axum, sea-orm, unocss, web, modern', 'Romi Nest', '/favicon.ico', '/favicon.ico', '/api/utils/background', '/api/utils/qqavatar', 'Arimura Sena', '👋 Hi there, this is my personal website and blog\n🔧 It\'s frontend built with Angular and Lit, backend built with Axum and SeaORM\n🧩 The best like character is Himeno Sena (姬野星奏) and Arimura Romi (有村ロミ)\n🌱 I\'m currently learning Idris2 and Type Theory', '[[\"mdi:github\", \"GitHub\", \"https://github.com/biyuehu\"], [\"mdi:email\", \"Email\", \"mailto:me@i.arimuraromi.com\"], [\"mdi:qqchat\", \"QQ\", \"https://qm.qq.com/q/QbbNiQ6Tq6\"], [\"mdi:television-classic\", \"BiliBili\", \"https://space.bilibili.com/293767574\"], [\"mdi:animation-play\", \"Bangumi\", \"https://bgm.tv/user/himeno\"], [\"mdi:youtube\", \"YouTube\", \"\"], [\"mdi:alpha-x-box\", \"X\", \"\"], [\"mdi:square-rounded-badge\", \"Tieba\", \"\"], [\"mdi:telegram\", \"Telegram\", \"\"], [\"mdi:steam\", \"Steam\", \"\"], [\"mdi:reddit\", \"Reddit\", \"\"], [\"mdi:discord\", \"Discord\", \"\"], [\"mdi:xbox\", \"Xbox\", \"\"]]', '[{\"id\": 25, \"name\": \"about\", \"title\": \"关于\", \"hideToc\": true, \"routine\": true, \"template\": \"\", \"hideComments\": false}, {\"id\": 26, \"name\": \"log\", \"title\": \"日志\", \"hideToc\": false, \"routine\": true, \"template\": \"\", \"hideComments\": true}, {\"id\": 6, \"name\": \"links\", \"title\": \"友情链接\", \"hideToc\": false, \"routine\": false, \"template\": \"links\", \"hideComments\": false}]', '[{\"link\": \"https://i.arimuraromi.com\", \"name\": \"Romi Nest\", \"avatar\": \"/favicon.ico\", \"description\": \"ArimuraSena 的个人网站，基于 Angular & Rust\"}, {\"link\": \"https://l.himeno-sena.com\", \"name\": \"Sena Language\", \"avatar\": \"https://l.himeno-sena.com/favicon-7a447ed069013842.ico\", \"description\": \"基于 Rust 的实验性一等类型&依赖类型编程语言\"}, {\"link\": \"https://himeno-sena.com\", \"name\": \"Himeno Sena\", \"avatar\": \"https://himeno-sena.com/favicon.ico\", \"description\": \"姬野星奏的专属网站\"}, {\"link\": \"https://huoshen80.top/\", \"name\": \"火神80的小窝\", \"avatar\": \"https://huoshen80.top/favicon.ico\", \"description\": \"一位热爱 Coding、MC、原神、galgame 的b站up主\"}, {\"link\": \"https://kana.i.arimuraromi.com/\", \"name\": \"KanaRhythm\", \"avatar\": \"https://kana.i.arimuraromi.com/favicon.png\", \"description\": \"基于 MoonBit 语言的日语假名学习游戏\"}, {\"link\": \"https://gal.i.arimuraromi.com/\", \"name\": \"Nanno\", \"avatar\": \"https://gal.i.arimuraromi.com/assets/cover.png\", \"description\": \"基于 Rust 的 GAL 管理、统计、同步工具\"}, {\"link\": \"https://st.i.arimuraromi.com/\", \"name\": \"SenaTab\", \"avatar\": \"https://st.i.arimuraromi.com/icons/icon.png\", \"description\": \"基于 React 的浏览器起始页\"}, {\"link\": \"https://avg.js.org\", \"name\": \"AvgJS\", \"avatar\": \"https://avg.js.org/favicon.svg\", \"description\": \"轻量级视觉小说游戏制作引擎\"}, {\"link\": \"https://kotori.js.org\", \"name\": \"KotoriBot\", \"avatar\": \"https://kotori.js.org/favicon.svg\", \"description\": \"基于 Node + TS 的跨平台聊天机器人框架\"}, {\"link\": \"https://tool.i.arimuraromi.com\", \"name\": \"HULITOOL\", \"avatar\": \"https://tool.i.arimuraromi.com/favicon.ico\", \"description\": \"HULITOOL 工具箱\"}, {\"link\": \"https://api.i.arimuraromi.com\", \"name\": \"HotaruApi\", \"avatar\": \"https://api.i.arimuraromi.com/favicon.ico\", \"description\": \"超快超稳定的接口网站\"}]', '', '', 587, '', '', '', 0, 8, 0, '', '{}');


DROP TABLE IF EXISTS `romi_ip_blacklist`;
CREATE TABLE `romi_ip_blacklist` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
